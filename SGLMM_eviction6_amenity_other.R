...
saveRDS(fit_other, file='data/results/fit_other_final8_amenity.rds')

# Load the fitted model
fit_other <- readRDS("data/results/fit_other_final8_amenity.rds")
...
dim(df_samples)
write.csv(df_samples, "data/results/df_samples_other_final_8_amenity.csv")
...
# Save the results
write.csv(df_95ci, "data/results/df_95ci_other_final_8_amenity.csv")
View(df_95ci)
...
st_crs(df_np) <- 4326
write.csv(df_np, 'data/results/df_geom_other_final_8_amenity.csv')
head(df_np)
